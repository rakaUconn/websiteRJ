  ...
  publications: [
    {
      ...
      authors: 'R. Joshi, T. O’Connor, X. Shen, M. Wardlaw, B. Javidi',
      venue: 'Optics Express',
      year: '2020',
      pages: '28, 10477–10490',
      tags: ['Integral Imaging', 'Underwater Imaging', 'Optical Signal Detection'],
    },
    {
      id: 'pub2',
      title: 'Signal detection in turbid water using temporally encoded polarimetric integral imaging',
      authors: 'R. Joshi, G. Krishnan, T. O’Connor, B. Javidi',
      venue: 'Optics Express',
      year: '2020',
      pages: '28, 36033–36045',
      tags: ['Polarimetric Imaging', 'Integral Imaging', 'Underwater Imaging'],
    },
    {
      id: 'pub3',
    ...
    {
      id: 'pub4',
      title: 'High-speed 3D integral imaging for sensing and visualization of dynamic underwater events',
      authors: 'R. Joshi, J. Lee, B. Javidi',
      venue: 'Optics Continuum',
      year: '2024',
      pages: '3, 1498–1508',
      tags: ['Integral Imaging', 'High-Speed Imaging', 'Underwater Imaging'],
    },
    {
      id: 'pub5',
      title:
      ...
      authors: 'V. Singh, R. Joshi, S. Tayal, D. S. Mehta',
      venue: 'Laser Physics Letters',
      year: '2019',
      pages: '16, 025604',
      tags: ['Quantitative Phase Imaging', 'Optical Coherence', 'Biomedical Imaging'],
    },
    {
      id: 'pub6',
      title: 'Human gesture recognition under degraded environments using 3D-integral imaging and deep learning',
      authors: 'G. Krishnan, R. Joshi, T. O’Connor, F. Pla, B. Javidi',
      venue: 'Optics Express',
      year: '2020',
      pages: '28, 19711–19725',
      tags: ['Integral Imaging', 'Deep Learning', 'Gesture Recognition'],
    },
    {
      id: 'pub7',
      title: 'Optical signal detection in turbid water using multidimensional integral imaging with deep learning',
      authors: 'G. Krishnan, R. Joshi, T. O’Connor, B. Javidi',
      venue: 'Optics Express',
      year: '2021',
      pages: '29, 35691–35701',
      tags: ['Integral Imaging', 'Deep Learning', 'Underwater Imaging'],
    },
    {
      id: 'pub8',
      ...
      authors: 'Y. Huang, G. Krishnan, T. O’Connor, R. Joshi, B. Javidi',
      venue: 'Optics Express',
      year: '2023',
      pages: '31, 1367–1385',
      tags: ['Integral Imaging', 'Deep Learning', 'Underwater Imaging'],
    },
    {
      ...
      authors: 'G. Krishnan, Y. Huang, R. Joshi, T. O’Connor, B. Javidi',
      venue: 'Optics Express',
      year: '2021',
      pages: '29, 30937–30951',
      tags: ['Integral Imaging', 'Gesture Recognition', 'RGB-D Sensing'],
    },
    {
      id: 'pub10',
      title: 'Three-dimensional integral imaging-based image descattering and recovery using physics informed unsupervised CycleGAN',
      authors: 'G. Krishnan, S. Goswami, R. Joshi, B. Javidi',
      venue: 'Optics Express',
      year: '2024',
      pages: '32, 1825–1835',
      tags: ['Integral Imaging', 'Deep Learning', 'Image Descattering'],
    },
    {
      id: 'pub11',
      title:
      ...
      authors: 'K. Usmani, A. Ahmad, R. Joshi, V. Dubey, A. Butola, D. S. Mehta',
      venue: 'Journal of the Optical Society of America A',
      year: '2019',
      pages: '36, D41–D46',
      tags: ['Optical Coherence Microscopy', 'Spatial Coherence'],
    },
    {
      id: 'pub12',
      title: 'Underwater optical imaging and sensing in turbidity using three-dimensional integral imaging: a review',
      authors: 'A. Maric, G. Krishnan, R. Joshi, Y. Huang, K. Usmani, B. Javidi',
      venue: 'Advanced Imaging',
      year: '2024',
      pages: '2, 012001',
      tags: ['Integral Imaging', 'Underwater Imaging', 'Review'],
    },
  ],

  patents: [
    {
      title: 'Method For Optical Signal Detection in A Liquid And Articles Comprising The Same',
      status: 'Applied',
      applicationNo: 'Provisional Application No. 63/617,353',
      date: 'January 3, 2024',
      inventors: 'B. Javidi, Y. Huang, R. Joshi, G. Krishnan',
    },
  ],
